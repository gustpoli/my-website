...
export default function Home() {
  return (
    <main className="flex flex-col gap-20 min-h-[100vh]">
      ...
      >
        <div className="lg:container flex flex-col items-center w-full gap-y-16 p-3">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-5 w-full">
            <ProjectCard
              img={{
                src: '/images/siteImobiliario.png',
                alt: 'Picture of a project that consist in a real estate website template editable via a panel'
              }}
              project={{
                name: 'Real estate website template editable via a panel',
                techs: ['HTML', 'CSS', 'Bootstrap', 'JS', 'PHP']
              }}
              customClassName="flex-1 aspect-[16/9]"
            ></ProjectCard>
            <div className="flex-1  flex flex-col gap-5">
              <ProjectCard
                img={{
                  src: '/images/sistemaClinico.png',
                  alt: 'Picture of a project that consist in a system for clinics in use'
                }}
                project={{
                  name: 'A single-page (SPA) clinical system in use',
              ...
              <ProjectCard
                customClassName="  flex-1 aspect-[16/9]"
                img={{
                  src: '/images/siteImobiliarioNext.png',
                  alt: 'Picture of a real estate website made with NextJS 13.0'
                }}
                project={{
                  name: 'A real estate website',
                  techs: ['Tailwind', 'TS', 'NextJS']
                }}
              ></ProjectCard>
            </div>
          </div>
